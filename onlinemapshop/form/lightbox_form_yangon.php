...
/* Send the message using mail() function */
   if (count($errors) == 0) {		
			...
			$mailSub = 'Yangon Map Download (http://dpsmap.com/online_map_shop/index.shtml)'; // the subject of the email which you can change
			...
			foreach ($_POST as $field => $input) { 
				...
				$mailsub2="Thank you for inquiring about purchasing yangon map";
