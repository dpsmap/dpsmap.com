...
/* Send the message using mail() function */
   if (count($errors) == 0) {		
			...
			$mailSub = 'State & Division Book Map (English Version) (http://dpsmap.com/online_map_shop/index.shtml)'; // the subject of the email which you can change
			...
			foreach ($_POST as $field => $input) { 
				...
				$mailsub2="Thank you for inquiring about purchasing State & Division Book Map (English Version)";
