...
/* Send the message using mail() function */
   if (count($errors) == 0) {		
			...
			$mailSub = 'Kyaiktiyo Map Download (http://dpsmap.com/kyaiktiyo/index.shtml)'; // the subject of the email which you can change
			...
			foreach ($_POST as $field => $input) { 
				...
				$header2 .= "bcc: $BCCMail \r\n";				
				$mailsub2="Thank You for inquiring about downloading free kyaiktiyo map";
...
http://bit.ly/kyaiktiyoly (705.08 KB)
