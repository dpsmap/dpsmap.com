...
include("../db.php");
	...
	if(isset($_POST['btnKyaiktiyo']))//Start btnKyaiktiyo
	{
	...
	/*************Send email to Owner Start***************************/
		...
		$mailSub = 'Kyaiktiyo Map Download (http://dpsmap.com/download/Kyaiktiyo Map.html)'; // the subject of the email which you can change
		...
		$message.="http://www.dpsmap.com/kyaiktiyo/confirmationkyaiktiyo.php?passkey=$confirm_code \r \n";
