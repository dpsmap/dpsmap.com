...
<html lang="en">
  <head>
    ...
    <META NAME="keywords"
        ...
        <META NAME="description" content="Design Printing Services, Rakhine Map Free Download">
    <meta
        ...
        <div class="main-content">
                <div class="mission" style="padding-top: 30px;padding-bottom: 0px;">
                    <div class="description-container">
                            <div class="heading">
                                <div class="main-heading">The Map Of Rakhine</div>
                            </div>
                        <p class="description">
                            Rakhine people or Arakanese are the largest ethnic groups in Myanmar. Rakhine State is situated on the western coast in Myanmar, 
                            it is bordered by Chin State to the north, Magway Region, Bago Region and Ayawaddy Region to the east, 
                            the Bay of Bengal to the west and the Chittagong Division of Bangladesh to the northwest. 
                            Arakanese means - a Burmese people of the western Arakan coastlands of Myanmar. Sittwe is the capital city of Rakhine State. 
                            Their estimate population is around 3-4 millions.
                        </p>
                    </div>
                </div>
        </div>
      ...
      <div class="map-overview">
        <div class="map-overview-left">
          ...
          <div class="map-overview-image-container">
            <img src="../downloadmap/images/RakhineMap.jpg" alt="Magway Map" />
          ...
          <div class="custom-row">
            <div class="heading">
              ...
              <div class="sub-heading">
                To download full and complete Rakhine Map
              </div>
            </div>

            <ol>
              <li>Press <a href="../pages/map-download/?value=Rakhine">Download</a></li>
