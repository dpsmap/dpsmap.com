					...
					<div class="row">
						<div class="wrap-col">
								<div class="header">
									<div class="row">
										<div class="col-4-5">
											<h1 style="font-size:20px;line-height:20px;letter-spacing:0px;">Taunggyi Map  Download</h1>
										</div>
										<div class="col-1-5">
									...
									if($result1)//if successfully queried
{
	...
	if($result2)
	{
       ...
       <p style="text-align:center;"> <button  onclick="window.location.href='images/taunggyi.zip';this.disabled=true; this.value='Please Wait...';" name="btndownload">Download Here</button></p>
<?php
