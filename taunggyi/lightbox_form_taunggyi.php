...
/* Send the message using mail() function */
   if (count($errors) == 0) {		
			...
			$mailSub = 'Taunggyi Map Download (http://dpsmap.com/taunggyi/index.htm)'; // the subject of the email which you can change
			...
			foreach ($_POST as $field => $input) { 
				...
				$header2 .= "bcc: $BCCMail \r\n";				
				$mailsub2="Thank You for inquiring about downloading free sittwe map";
...
http://bit.ly/taunggyily (1.05 MB)
