...
include("../db.php");
	...
	if(isset($_POST['btnTaunggyi']))//Start btnTaunggyi
	{
	...
	/*************Send email to Owner Start***************************/
		...
		$mailSub = 'Taunggyi Map Download (http://dpsmap.com/download/Taunggyi Map.html)'; // the subject of the email which you can change
		...
		$message.="http://www.dpsmap.com/taunggyi/confirmationtaunggyi.php?passkey=$confirm_code \r \n";
