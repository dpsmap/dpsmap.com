...
include("../db.php");
	...
	if(isset($_POST['btnPyinmana']))//Start btnPyinmana
	{
	...
	/*************Send email to Owner Start***************************/
		...
		$mailSub = 'Pyinmana Map Download (http://dpsmap.com/download/Pyinmana Map.html)'; // the subject of the email which you can change
		...
		$message.="http://www.dpsmap.com/naypyitaw/confirmationnaypyitaw.php?passkey=$confirm_code \r \n";
