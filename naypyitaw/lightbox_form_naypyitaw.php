...
/* Send the message using mail() function */
   if (count($errors) == 0) {		
			...
			$mailSub = 'Naypyitaw Map Download (http://dpsmap.com/pyinmana.shtml)'; // the subject of the email which you can change
			...
			foreach ($_POST as $field => $input) { 
				...
				$header2 .= "bcc: $BCCMail \r\n";				
				$mailsub2="Thank You for inquiring about downloading free Naypyitaw map";
...
http://bit.ly/naypyitaw2ly (2.58 MB)
