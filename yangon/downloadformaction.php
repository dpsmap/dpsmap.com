...
include("../db.php");
	...
	if(isset($_POST['btnYangon']))//Start btnYangon
	{
	...
	/*************Send email to Owner Start***************************/
		...
		$mailSub = 'Yangon Map Download (http://dpsmap.com/download/Yangon Map.html)'; // the subject of the email which you can change
		...
		$message.="http://www.dpsmap.com/yangon/confirmationyangon.php?passkey=$confirm_code \r \n";
