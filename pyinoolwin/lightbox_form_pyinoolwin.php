...
/* Send the message using mail() function */
   if (count($errors) == 0) {		
			...
			$mailSub = 'Pyin Oo Lwin Map Download (http://dpsmap.com/pyinoolwin/index.shtml)'; // the subject of the email which you can change
			...
			foreach ($_POST as $field => $input) { 
				...
				$header2 .= "bcc: $BCCMail \r\n";				
				$mailsub2="Thank You for inquiring about downloading free pyin oo lwin map";
...
http://bit.ly/pyinoolwinly (868.17KB)
