...
<html lang="en">
  <head>
    ...
    <META NAME="keywords"
         ...
         <META NAME="description" content="Pyin Oo Lwin / Mya Myo Map free download PDF">
    <meta
  ...
  <link rel="stylesheet" href="../assets/libs/fontawesome/css/all.min.css" />
    ...
    <title>Pyin Oo Lwin Map - DPS </title>
    <style>
        .responsive {
            width: 100%;
            max-width: 600px;
        ...
        <div class="main-content">
                <div class="mission" style="padding-top: 30px;padding-bottom: 0px;">
                    <div class="description-container">
                            <div class="heading">
                                <div class="main-heading">The Map Of Pyin Oo Lwin</div>
                    </div>
                        <p class="description">
                            Pyin Oo Lwin was founded as the British Hill Station 'Maymyo'. The name Maymyo, translating as 'May Town', came from Colonel May of the 5th Bengal Regiment who in 1866 established the town as a holiday location for British Army officers based in Mandalay.
                        </p>
                    </div>
            </div>
        </div>
      ...
      <div class="map-overview">
        <div class="map-overview-left">
          ...
          <div class="map-overview-image-container">
            <img src="images/Pyin-oo-Lwin.jpg" alt="Pyin-oo-Lwin" />
          ...
          <div class="custom-row">
            <div class="heading">
              ...
              <div class="sub-heading">
                To download full and complete PyiOoLwin Map
              </div>
            </div>

            <ol>
              <li>Press <a href="../pages/map-download/?value=PyiOoLwin">Download</a></li>
             ...
             <div>
                <a href="https://dpsmap.com/mapplotting.shtml">
                    <img src="../assets/images/map-ads.png" class="responsive" alt="map-ads photo" >
                </a>
            </div>
