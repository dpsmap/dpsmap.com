...
include("../db.php");
	...
	if(isset($_POST['btnPyinoolwin']))//Start btnPyinoolwin
	{
	...
	/*************Send email to Owner Start***************************/
		...
		$mailSub = 'Pyinoolwin Map Download (http://dpsmap.com/download/Pyinoolwin Map.html)'; // the subject of the email which you can change
		...
		$message.="http://www.dpsmap.com/pyinoolwin/confirmationpyinoolwin.php?passkey=$confirm_code \r \n";
