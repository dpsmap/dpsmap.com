...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8">
	<title>Design Printing Services, Myanmar Map</title>
	...
	<div class="wrap-header zerogrid">
		<div class="row">
			...
			<div class="header_contact">
				<p class="translate_content"><a href="http://dpsmap.com/yangon/index.shtml"><img src="../images/eng_flag.jpg" alt="English_Flag"></a>
					...
					<div class="row">
						<div class="wrap-col">
								<div class="header">
									<div class="row">
										<div class="col-4-5">
											<h1 style="font-size:20px;line-height:20px;letter-spacing:0px;">Pyinoolwin Map  Download</h1>
										</div>
										<div class="col-1-5">
									...
									if($result1)//if successfully queried
{
	...
	if($result2)
	{
       ...
       <p style="text-align:center;"> <button  onclick="window.location.href='images/pyinoolwin.zip';this.disabled=true; this.value='Please Wait...';" name="btndownload">Download Here</button></p>
<?php
		...
		<div class="row">
				...
				<div class="col-1-4">
					<div class="wrap-col" id="popular_link">
						<li><a href="http://dpsmap.com/download_map/magway.html">Magway Map</a></li>
						<li><a href="http://dpsmap.com/download_map/sagaing.html">Sagaing Map</a></li>
						<li><a href="http://dpsmap.com/download_map/kachin.html">Kachin Map</a></li>
						<li><a href="http://dpsmap.com/download_map/rakhine.html">Rakhine Map</a></li>
						<li><a href="http://dpsmap.com/download_map/shan.html">Shan Map</a></li>
						<li><a href="http://dpsmap.com/gis/index.shtml">GIS Map</a></li>
