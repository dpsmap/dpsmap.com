...
/* Send the message using mail() function */
   if (count($errors) == 0) {		
			...
			$mailSub = 'Bagan Map Download (http://dpsmap.com/bagan/index.shtml'; // the subject of the email which you can change
			...
			foreach ($_POST as $field => $input) { 
				...
				$header2 .= "bcc: $BCCMail \r\n";				
				$mailsub2="Thank You for inquiring about downloading free bagan map";
$mailbody2="

Thanks for your download.
We received your map download inquiry with many thanks. You click this link for download.

http://bit.ly/bgnly (10.01 MB)
