...
<html lang="en">
  <head>
    ...
    <META NAME="keywords"
        ...
        <META NAME="description" content="Design Printing Services, Mon Map Free Download">
    <meta
        ...
        <div class="main-content">
                <div class="mission" style="padding-top: 30px;padding-bottom: 0px;">
                    <div class="description-container">
                            <div class="heading">
                                <div class="main-heading">The Map Of Mon State</div>
                            </div>
                        <p class="description">
                            The Mon are an ethnic group that originated in China and settled in northern Myanmar as early as the third century B.C. . 
                            They are believed to have spread from China to the Chao Phraya River basin in Thailand.
                            The Mon were politically independent until 1757 when they were defeated by the Burmese. T
                            he Mon are involved in the insurgency movement against Myanmar's military government. 
                            The Mon are believed to have been among the first people of Indochina and founded some of the earliest civilizations in the region. 
                            They also spread Theravada Buddhism to surrounding countries. 
      ...
      <div class="map-overview">
        <div class="map-overview-left">
          ...
          <div class="map-overview-image-container">
            <img src="../downloadmap/images/mon_map.jpg" alt="Mon Map" />
          ...
          <div class="custom-row">
            <div class="heading">
              ...
              <div class="sub-heading">
                To download full and complete Mon Map
              </div>
            </div>

            <ol>
              <li>Press <a href="../pages/map-download/?value=Mon">Download</a></li>
