...
<html lang="en">
  <head>
    ...
    <META NAME="keywords"
        ...
        <META NAME="description" content="Design Printing Services,Ayeyarwaddy Map, Ayeyarwaddy Map  Free Download">
    <meta
  ...
  <link rel="stylesheet" href="../assets/libs/fontawesome/css/all.min.css" />
    ...
    <title>Ayeyarwaddy Map - DPS </title>
    <style>
        .responsive {
            width: 100%;
            max-width: 600px;
    ...
    <div class="main-content">
                <div class="mission" style="padding-top: 30px;padding-bottom: 0px;">
                    <div class="description-container">
                            <div class="heading">
                                <div class="main-heading">The Map Of Ayeyarwaddy Region</div>
                            </div>
                        <p class="description">
                            Also known as the Delta region, the Ayeyarwaddy consists of 26 townships and a number of lakes. 
                            The other rivers that branch out from the main Ayeyarwaddy River are Ngawun, Pathein and Toe. 
                            The region covers an area of 35,140 square kilometres, with the Bamar and Karen ethnic groups forming the majority of the population that reside there.
                        </p>
                    </div>
                </div>
    </div>
      ...
      <div class="map-overview">
        <div class="map-overview-left">
          ...
          <div class="map-overview-image-container">
            <img src="../downloadmap/images/ayeyar_map.jpg" alt="Mon Map" />
          ...
          <div class="custom-row">
            <div class="heading">
              ...
              <div class="sub-heading">
                To download full and complete Ayeyarwaddy Map
              </div>
            </div>
