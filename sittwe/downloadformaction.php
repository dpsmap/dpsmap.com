...
include("../db.php");
	...
	if(isset($_POST['btnSittwe']))//Start btnSittwe
	{
	...
	/*************Send email to Owner Start***************************/
		...
		$mailSub = 'Sittwe Map Download (http://dpsmap.com/download/Sittwe Map.html)'; // the subject of the email which you can change
		...
		$message.="http://www.dpsmap.com/sittwe/confirmationsittwe.php?passkey=$confirm_code \r \n";
