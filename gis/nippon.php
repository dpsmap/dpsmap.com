...
<html lang="en">
    ...
    <head>
        ...
        <title> NIPPON and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Nippon Koei Co., Ltd. It is an aid to the government to build roads and bridges, and it is
                            time to find a map and submit it to the government according to the needs of the Thilawa
                            Division and can submit the project to the Government in a timely manner. Maps provided
                            support for the project.
                        </p>
                        <div>
                            <img src="/valuedclients/images/nippon.jpg" alt="nippon" class="responsives" />
                        </div>
