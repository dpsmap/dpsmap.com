...
<html lang="en">
    ...
    <head>
        ...
        <title> IGE GROUP and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Our IGE group service is UAB (United Amra Bank). As our bank services lending about time
                            loan with collateral such as home, factory or business when we carried out a valuation of
                            the property, we have to maintain the database about the location and charges altogether
                            after uploading the locations on map. That is why we choose to install GIS from DPS.
                            Besides, we also purchased GIS maps from DPS for the purpose of using in Telecom business
                            and reporting GIS maps of Yangon, Mandalay, Rakhine and Tanintharyi to Myanmar
                            Telecommunication. We satisfied that DPS is patient with their customers. They service to
                            reverse teaching again and again because we have staff in and out very often.
                        </p>
                        </br></br>
                        <div>
                            <img src="/valuedclients/images/igegroup.jpg" alt="igegroup" class="responsives" />
                        </div>
