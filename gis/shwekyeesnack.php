...
<html lang="en">
    ...
    <head>
        ...
        <title> SHWE KYEE SNACK and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            We are from Shwe Kyee snack production. We always have a problem if the drivers from our
                            company had any accidents__ was the accident happened by our drivers fault or others’ fault?
                            Did he go through red traffic light? Did he stop at the unstoppable sign area? Did the
                            driver cheat the company?

                            After we have been installed the Black Box from DPS, we’ve got the video record of all day
                            route of the vehicle and when we connect the data online, we are able to replay the video
                            file of the routes.

                            We can also find out wrong directions instead of the way we want to send. That is why Black
                            Box from DPS greatly supports us.
                        </p>
                        </br></br>
                        <div>
