...
<html lang="en">
    ...
    <head>
        ...
        <title> SAMPAROO and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Our compan is distribute Mineral Water.We bought DPS-GIS Map of Yangon from DPS Co., Ltd.And
                            also real time gps tracker.After we bought the GIS Map from DPS,we locate the our retail
                            outlet on map and we can seen the left place to distribute and marketing. When we install
                            the GPS Tracker to our delivery car, our sales team also more effective working.
                        <div>
                            <img src="/valuedclients/images/samparoo.jpg" alt="samparoo" class="responsives" />
                        </div>
