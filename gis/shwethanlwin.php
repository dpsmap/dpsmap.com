...
<html lang="en">
    ...
    <head>
        ...
        <title> SHWE THAN LWIN and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Our business is building the road, and the state and region responsible for the tower work.
                            Before going down to the ground for our business on the GIS Map of the cities, first and
                            foremost. It is also possible to save time on the ground by saving time and by making it
                            easier to work. DPS is offering GIS maps for short access.
                        </p>
                        </br></br>
                        <div>
                            <img src="/valuedclients/images/shwethanlwin.jpg" alt="shwethanlwin" class="responsives" />
                        </div>
