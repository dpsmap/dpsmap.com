...
<html lang="en">
    ...
    <head>
        ...
        <title> Shwe Naing Gan and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Our company services publishing and papers distribution. We also deliver to our partners who
                            work as publishing and papers distribution. When we give our services to our customers, some
                            employers want their goods in exact time. Sometime, we have to deliver items to countryside.
                            Thus, we want to know about the situation of our cars: how drivers drive with what speed.
                            Therefore, we installed GIS from DPS. We only give the duty to admin to watch the situation.
                            The speed is important in operation cars which are going to rural areas. So we make regular
                            speed and if the driver drives over speed, the device alarms us. We got satisfaction because
                            we know all things about them. The security of our vehicles is also safe.
                        </p>
                        </br></br>
                        <div>
                            <img src="/valuedclients/images/shwenainggan.jpg" alt="Shwe Naing Gan"
                                class="responsives" />
                        </div>
