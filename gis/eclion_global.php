...
<html lang="en">
    ...
    <head>
        ...
        <title> ECLION GLOBAL and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Our Co. Ltd produces and distributes glasses. We have to service important constructions. We
                            have to deliver goods that are manufactured from our factory to construction sites and
                            retail outlets. After installing GIS Yangon Map from DPS, we can see the spreading of our
                            goods and location. So we have known the places that we need to expand market. We have used
                            GPS offline devices to know how it works. Now we use GPS online devices because it is very
                            convenient for us.
                        <div>
