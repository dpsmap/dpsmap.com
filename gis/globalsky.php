...
<html lang="en">
    ...
    <head>
        ...
        <title> GLOBAL SKY and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Our Global Sky Co., Ltd. distributes divers for kids and old people. When we distribute
                            goods to numerous shops in the country, we have to upload the data of our shops and the way
                            of our sale team on the map. We’ve known obviously where to go. We purchased GPS and GIS
                            maps from DPS for the purpose of expanding the number of our shops and to be active our
                            work. We can watch our sale teams’ daily routine in real time after installing online GPS
                            devices for our delivery vehicles of our sale teams.
                        <div>
                            <img src="/valuedclients/images/globalsky.jpg" alt="globalsky" class="responsives" />
                        </div>
