...
<html lang="en">
    ...
    <head>
        ...
        <title> Vivala and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            We distribute clothes to rural areas. We install Black-Box camera from DPS in our cars. The
                            purpose of installing Black-Box is to record goods lists along the trip as we have to load
                            up our vehicles with goods. When we replay video records, we have known about how they work
                            whether they work exactly or not. We can also know whether the staffs are performing their
                            duties and responsibilities wisely.
                        </p>
                        </br></br>
                        <div>
                            <img src="/valuedclients/images/vivala.jpg" alt="Vivala" class="responsives" />
                        </div>
