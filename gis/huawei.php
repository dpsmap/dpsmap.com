...
<html lang="en">
    ...
    <head>
        ...
        <title> HUAWEI and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Huawei Myanmar is the company for establishing networks, providing smart phones and offering
                            services. From DPS, we propose GIS maps of Yangon, Mandalay, Naypyidaw and the locations of
                            high condominiums, office, banks, schools, colleges, hotels and housing estates along with
                            Lat Long to receive data.
                        </p>
                        </br></br>
                        <div>
                            <img src="/valuedclients/images/huawei.jpg" alt="huawei" class="responsives" />
                        </div>
