...
<html lang="en">
    ...
    <head>
        ...
        <title> ECHNO VISION and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            We have bought GIS Map and GPS Tracker from DPS Company. DPS help and support us by Mapping
                            and GPS ,after sales services.This GIS Map technology help us a lot.
                        <div>
                            <img src="/valuedclients/images/technovision.jpg" alt="technovision" class="responsives" />
                        </div>
