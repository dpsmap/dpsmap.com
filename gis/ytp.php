                ...
                <div class="map-description">
                    <div class="custom-heading">
                        <div class="main-heading">
                            YTP (YATANARPONE TELEPORT)
                        </div>
                    </div></br></br>
                    <div class="description">

                        <p class="big">
                            Our Co. Ltd provides internet services. We need maps when we plan to draw fiber optic
                            cables. We also need to measure the length of roads. As we use Yangon and Mandalay maps
                            which are GIS maps, we can calculate the costs before we start operation. When we start our
                            operation, we can reduce extra cost because we don’t have to use unnecessary things.
                        </p>
                        </br></br>
                        <div>
                            <img src="/valuedclients/images/ytp.jpg" alt="ytp" class="responsives" />
                        </div>
