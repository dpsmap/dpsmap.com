...
<html lang="en">
    ...
    <head>
        ...
        <title> Red Line and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Our company is media and advertising.our main services is to advertising the customer
                            products.When London Cigarette come to us and give project ot us.We bought DPS-GIS Map of
                            yangon to put the retail outlet of products and then we find out there is more places to
                            distribute. DPS-GIS Map is very helpful.
                        <div>
                            <img src="/valuedclients/images/redline.jpg" alt="redline" class="responsives" />
                        </div>
