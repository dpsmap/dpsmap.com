...
<html lang="en">
    ...
    <head>
        ...
        <title> KTT Group and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Our KTT Group distributes various kinds of snack from Thailand. When we distribute the goods
                            to numerous shops in the country, we have to upload the data of our shops and the way of our
                            sale team on the map. It is really helpful to us. It is also obvious where to go. We
                            purchased GPS and GIS maps from DPS for the purpose of expanding the number of our shops and
                            to be active our work. We can watch our sale teams’ daily routine in real time after
                            installing online GPS devices for our delivery vehicles of our sale teams.
                        </p>
                        </br></br>
                        <div>
                            <img src="/valuedclients/images/ktt.jpg" alt="KTT Group" class="responsives" />
                        </div>
