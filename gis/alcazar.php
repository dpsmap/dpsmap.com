...
<html lang="en">
    ...
    <head>
        ...
        <title> ALCAZAR and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Our main business is telecommunication services.In our business, we have to know why our
                            telecom are located because the tower are must be spread out.After we bought DPS GIS Map we
                            don’t need to do survey by ourself and no waste time.So,Thank you DPS for your help.
                        </p>
                        </br></br>
                        <div>
                            <img src="/valuedclients/images/alcazar.jpg" alt="ALCAZAR" class="responsives" />
                        </div>
