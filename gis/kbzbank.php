...
<html lang="en">
    ...
    <head>
        ...
        <title> KBZ BANK and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            We carry out Shwe Kanbawza Services. We also provide loans and lending services to our bank.
                            Mortgages When we do business loans, we provide them with a location on the map. For that,
                            the map was encouraged to DPS-GIS. Yangon, Myanmar GIS map is encouraged. DPS is also
                            passionate about educating our entrepreneurs on the mapping, as well as having the staff
                            change over and over again because of the changing staffing. Since our staff has hundreds of
                            buses, we have also been working to install GPS systems on our buses, so our buses are on
                            time, regularly and regularly. There is no need for unnecessary expenses, and that has
                            contributed to our work.
                        </p>
                        <div>
                            <img src="/valuedclients/images/kbzbank.jpg" alt="kbzbank" class="responsives" />
                        </div>
