...
<html lang="en">
    ...
    <head>
        ...
        <title> ERICSSON and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    <div class="custom-heading">
                        ...
                        <p class="big">
                            We provide security services at our tower. DPS - GIS Map was used to identify the cities in
                            which our security was used. It has made things easier.
                        </p>
                   
                    </div>
                    
                        <div>
                            <img src="/valuedclients/images/ericsson.jpg" alt="ericsson" class="responsives" />
                        </div>
