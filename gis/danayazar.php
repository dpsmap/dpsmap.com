...
<html lang="en">
    ...
    <head>
        ...
        <title> DANAYAZAR and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            our company limited distributed Generator with the name of Rino Brand and also electric
                            cable services for those which village are not available electricity. When we do the
                            electric cable services, we need to have Map for usage in planning.So we bought GIS-map from
                            DPS.When we want get the map,we can do so many planning on this map and its reduce our cost
                            and time.And also DPS-GPS Tracker is very useful for us,When we go for site hunting the car
                            need a track record and report. DPS-GPS help out this.
                        <div>
                            <img src="/valuedclients/images/danayazar.jpg" alt="danayazar" class="responsives" />
                        </div>
