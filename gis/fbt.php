...
<html lang="en">
    ...
    <head>
        ...
        <title> Fu Xing Brother Group and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
                ...
                <div class="map-description">
                    <div class="custom-heading">
                        <div class="main-heading">
                            Fu Xing Brother Group
                        </div>
                    </div></br></br>
                    <div class="description">

                        <p class="big">
                            Our Group distributes cigarette. We have to maintain database of our retails with the
                            location. We would like to prepare about the ways, to upload the location of the shops from
                            the ground on the map. We want to know the situation of our vehicles. On the other hand, we
                            can’t follow and check along the way. So we purchased GIS, GPS devices (Offline) from DPS to
                            install and use in our vehicles. We have noticed some requirements of the distribution area
                            after we upload the location of the operation area.
                        </p>
                        </br></br>
                        <div>
                            <img src="/valuedclients/images/fbt.jpg" alt="Fu Xing Brother Group" class="responsives" />
                        </div>
