...
<html lang="en">
    ...
    <head>
        ...
        <title> LOHEIN and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            DPS GIS-Map helped our problem very professionaly. Our problem is
                            1.we want to know our products is distributed to the whole yangon or not.
                            2.whic location are distributed and which are not.
                            3.Which location are left to distribution.
                            And DPS-GPS also help us our distribution delivery car to know the way plan,to track them,
                            report.
                        <div>
                            <img src="/valuedclients/images/lohein.jpg" alt="lohein" class="responsives" />
                        </div>
