...
<html lang="en">
    ...
    <head>
        ...
        <title> HORIZON TELECOM and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Our Horizon Telecom Int’l has provided telecom service, Wifi, for the purpose of using our
                            Telecom Service and for setting up yangon on towers to set up Wifi, which is costly and
                            time-saving, as well as being able to plan ahead and plan on maps.
                        </p>
                        </br></br>
                        <div>
                            <img src="/valuedclients/images/horizontelecom.jpg" alt="horizontelecom"
                                class="responsives" />
                        </div>
