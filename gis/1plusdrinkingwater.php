...
<html lang="en">
    ...
    <head>
        ...
        <title> 1 PLUS DRINKING WATER and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
                ...
                <div class="map-description">
                    <div class="custom-heading">
                        <div class="main-heading">
                            1 PLUS DRINKING WATER
                        </div>
                    </div></br></br>
                    <div class="description">

                        <p class="big">
                            Since 1Plus has dispatched bottled water to take home shops, DPS uses the service of Vehical
                            Tracking System from DPS to see how fast your car is moving and moving beyond your specified
                            speed. DPS has been very pleased with the use of the Services because of the support they
                            provide.
                        <div>
