            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            We are non-profit organization (NGO) and we bought GIS-Map from DPS for usage in our work.We
                            provide every department in our organization which is need of map. And everytime when we
                            need the map we always go to DPS because of DPS can provide very big map and clear map every
                            single time.
                        </p>
                        <div>
                            <img src="/valuedclients/images/undp.jpg" alt="undp" class="responsives" />
                        </div>
