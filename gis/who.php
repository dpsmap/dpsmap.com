            ...
            <div class="main-content">
                <div class="map-description">
                    <div class="custom-heading">
                        ...
                        <ul>
                            <ol>
                                1.DPS Provide the GIS fomart map of village track that include clinics, hospitals for
                                Ministry of Health.
                            </ol>
                            </br>
                            <ol>
                                2.Ministry of Health provided a sample map of village track and DPS redraw as a GIS
                                fomart map.
                            </ol>
                            </br>
                            <ol>
                                3.Print out the location point for on map for RHC,Sc.
                            </ol>
                            </br>
                        </ul>
                        </p>
                    ...
                    <div class="description">
                        ...
                        <div>
                            <img src="/valuedclients/images/who.jpg" alt="who" class="responsives" />
                        </div>
