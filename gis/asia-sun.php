...
<html lang="en">
    ...
    <head>
        ...
        <title> Asia Sun and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Our Asia Sun Group is petrol distribution company Limited.We need the map to deliver our
                            petrol to the shop.When we got the gis map from DPS Company we put our shop location to the
                            map and we can seen more demand markets on the map.Also The GPS Tracker is help a lot.
                        <div>
                            <img src="/valuedclients/images/asia-sun.jpg" alt="asia-sun" class="responsives" />
                        </div>
