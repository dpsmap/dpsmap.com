            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Maps are required to set up Shop Database for Carlsberg distribution. Therefore, DPS and
                            their existing GIS Map are used to build Shop Database in Yangon, Mandalay, Nay Pyi Taw,
                            Taung Gyi, Mawlamyaing, Monywa, Basgo, Pathein, Pay, Lashio, Hinthada.
                        <div>
                            <img src="/valuedclients/images/tns.jpg" alt="tns" class="responsives" />
                        </div>
