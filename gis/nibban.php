...
<html lang="en">
    ...
    <head>
        ...
        <title> NIBBAN and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Our Nibban company limited is manufacturing and distribution the electricity goods in the
                            name of NIBBAN.Our Products are such as Air Cooler, Aircon, Electric Fan and Iron etc. We
                            bought GIS Map from DPS Co., Ltd and we put our location to the GIS Map.Afte that we can
                            know that our retail outlet location.
                        </p>
                        </br></br>
                        <div>
                            <img src="/valuedclients/images/nibban.jpg" alt="nibban" class="responsives" />
                        </div>
