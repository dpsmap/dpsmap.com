...
<html lang="en">
    ...
    <head>
        ...
        <title> MEGA WE CARE and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            MEGA Life Sciences Established in 1982, Mega Lifesciences public company limited is actively
                            involved in helping millions of people have access to safe, effective, world class world
                            class medicines. MEGA acquired DPS' GIS database especially Yangon Streets which can be used
                            to accurately place the Retail Outlets for its products. DPS who already owned Yangon Street
                            GIS database in UTM coordinates helped MEGA IT team with GPS data collection to collect shop
                            data. MEGA expressed the maps DPS provided are useful for day to day distribution and
                            enhancing investor relationship.
                        <div>
                            <img src="/valuedclients/images/mega.jpg" alt="mega" class="responsives" />
                        </div>
