...
<html lang="en">
    ...
    <head>
        ...
        <title> IRRAWADDY and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
                ...
                <div class="map-description">
                    <div class="custom-heading">
                        <div class="main-heading">
                          ...
                          <p class="big">
                            Our work is servicing the tower for telecommunication and when they was no map we are facing
                            a problem after that we got a Map from DPS and the dps map is really work for us.
                        </p>
                    </div>
                        <div>
                            <img src="/valuedclients/images/Irrrawaddy.jpg" alt="Irrrawaddy" class="responsives" />
                        </div>
                    </div>
