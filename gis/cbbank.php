...
<html lang="en">
    ...
    <head>
        ...
        <title> CB BANK and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            CB Bank was a DPS old customer since DPS started as a company. CB bank always support to DPS
                            and put advertising in The Map of Yangon, Yangon Township Map. As a CB Bank,they also
                            support us Kaytumadi Dynasty Hotel.They put ads on Tourist Map of Bagan.CB Bank is DPS
                            valuable clients and supporter always.
                        </p>
                        <div>
                            <img src="/valuedclients/images/cbbank.jpg" alt="cbbank" class="responsives" />
                        </div>
