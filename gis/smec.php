            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            SMEC has supported my business by encouraging GPS and GIS Map from DPS to obtain ground data
                            for tower construction. Thanks to DPS for their support.
                        </p>
                        </br></br>
                        <div>
                            <img src="/valuedclients/images/smec.jpg" alt="smec" class="responsives" />
                        </div>
