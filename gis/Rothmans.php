...
<html lang="en">
    ...
    <head>
        ...
        <title> Rothmans and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            By making use of database storage, DPS has launched the Vehicle tracking system since 2014
                            for increasing sales. By using it and distributing, we have installed GPS trackers in the
                            vehicles. They have strongly cooperated with DPS in distributing and selling GIS Maps in
                            Myanmar. In the cities where Virginia Tobacco Co. Ltd office locations are available, DPS
                            can provide service by displaying zooming and plotting on the Myanmar maps of DPS.
                        </p>
                        </br></br>
                        <div>
                            <img src="/valuedclients/images/Rothmans.jpg" alt="Rothmans" class="responsives" />
                        </div>
