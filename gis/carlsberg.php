...
<html lang="en">
    ...
    <head>
        ...
        <title> CARLSBERG and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            They have been able to encourage the distribution of their distribution stores across Yangon
                            for the Carlsberg distribution, enabling DPS's GIS Map, Yangon, to increase their
                            distribution and highlight existing vacancies and meet demand.
                        </p>
                        </br></br>
                        <div>
                            <img src="/valuedclients/images/carlsberg.jpg" alt="carlsberg" class="responsives" />
                        </div>
