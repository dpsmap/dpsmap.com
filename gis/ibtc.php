            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Our company bought a Yangon township map, Myanmar map, State and regional map from DPS to
                            usage for distribution.And also we have bought DPS-GPS Tracker from DPS, to monitor our car
                            and to get the report of that delivery car.
                            </br></br>
                        <div>
                            <img src="/valuedclients/images/ibtc.jpg" alt="ibtc" class="responsives" />
                        </div>
