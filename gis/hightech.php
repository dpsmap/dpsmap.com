...
<html lang="en">
    ...
    <head>
        ...
        <title> HIGH TECH and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Our company is construction company limited and everytime we need the map for our project we
                            bought GIS map from DPS.DPS can provide the map every time we need the map and we are very
                            satisified with this map.
                        </p>
                        </br></br>
                        <div>
                            <img src="/valuedclients/images/hightech.jpg" alt="hightech" class="responsives" />
                        </div>
