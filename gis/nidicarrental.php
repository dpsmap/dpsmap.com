...
<html lang="en">
    ...
    <head>
        ...
        <title> Ni Di Car Rental and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            I provide the car services to the tourists. Be specific when it comes to providing services
                            to guests. Particularly at times, some visitors have to pay for rent. When you drive your
                            car, do you drive in the direction you want to go, so that you do not have to drive too
                            hard? It is quite convenient to use the DPS-GPS Online device to get the information I need.
                        <div>
