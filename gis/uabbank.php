...
<html lang="en">
    ...
    <head>
        ...
        <title> UAB BANK and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Our bank has the home loan services and when customer are getting home loan from us.We put
                            the home location on map after putting location on map ,we can seen more easily the location
                            of our customer and their home. we bought GIS Map of yangon and mandaly from DPS.
                        </p>
                        <div>
                            <img src="/valuedclients/images/uabbank.jpg" alt="uabbank" class="responsives" />
                        </div>
