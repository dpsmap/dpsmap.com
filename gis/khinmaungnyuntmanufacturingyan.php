...
<html lang="en">
    ...
    <head>
        ...
        <title> KHIN MAUNG NYUNT MANUFACTURING and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Our Co, Ltd. manufactures and sells generators. We not only distribute generators to rural
                            areas but also provide services the difficulties after distributions. If some difficulties
                            happen, we have to go there very often. We also sell generators in showrooms from rural
                            areas. We had to plan to upload the location of our generator showrooms and used GIS and GPS
                            maps from DPS because we want to know about the report step by step. After using these
                            devices, we can work systematically more than before and DPS has also provided services for
                            a long time.
                        <div>
                            <img src="/valuedclients/images/khinmaungnyuntmanufacturingyan.jpg"
                                alt="khinmaungnyuntmanufacturingyan" class="responsives" />
                        </div>
