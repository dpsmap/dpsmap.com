...
<html lang="en">
    ...
    <head>
        ...
        <title> Secure Network and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            This customer bought Nay Pyi Taw Map as a GIS Digtal map fomart to usage with telecomunication tools.
                            Secure Networks for Small Businesses.
                        </p>
                        </br></br>
                        <div>
                            <img src="/valuedclients/images/securenetwork.jpg" alt="securenetwork" class="responsives" />
                        </div>
