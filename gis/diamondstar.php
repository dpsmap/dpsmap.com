...
<html lang="en">
    ...
    <head>
        ...
        <title> DIAMOND STAR and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Our company distributes flour to the whole country. We set location on Yangon GIS map to
                            expand our retail outlets as we want to know where are our retails spreading. After
                            installing GPS Off-Line devices in our vehicles, we can know whether our sale teams reach
                            retail outlets that we want them to go. Moreover, we get Total Kilo of fuel by using GPS
                            Off-Line devices. So we can give the fuel to our drivers with kilo by calculating with GPS.
                        <div>
                            <img src="/valuedclients/images/diamondstar.jpg" alt="diamondstar" class="responsives" />
                        </div>
