...
<html lang="en">
    ...
    <head>
        ...
        <title> KWATER and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Thanks to DPS Company, who provided the maps for their company. Thank you for your support
                            in many ways for their business.
                        </p>
                        <div>
                            <img src="/valuedclients/images/kwater.jpg" alt="kwater" class="responsives" />
                        </div>
