...
<html lang="en">
    ...
    <head>
        ...
        <title> FORTUNE and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            We need maps for our business to upload the cable fiber on maps connected with Telecom. When
                            we face the problem that we need to report Myanmar Telecommunication about GIS maps and our
                            cable fibers which are uploaded on map, we’ve got information that DPS has GIS maps. So we
                            used GIS maps from DPS and uploaded our cable fibers and it is much convenient for us. The
                            staffs from DPS well explain and teach us how to use. We satisfy that DPS also make us
                            practice.
                        </p>
                        </br></br>
                        <div>
                            <img src="/valuedclients/images/fortune.jpg" alt="fortune" class="responsives" />
                        </div>
