...
<html lang="en">
    ...
    <head>
        ...
        <title> TAUNG PAW THAR and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Our company distribute a tractor to the whole myanmar.We also sold tractor by instalment and
                            all the tractor are included warranty and after sals services.We have to take care our
                            customer always and maintaince. When customer need maintaince and service, we have to go way
                            and some time so far. DPS-GPS Tracker help us to know the real time of our car.
                        </p>
                        </br></br>
                        <div>
                            <img src="/valuedclients/images/taungpawthar.jpg" alt="taungpawthar" class="responsives" />
                        </div>
