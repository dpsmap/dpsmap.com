                ...
                <div class="map-description">
                    <div class="custom-heading">
                        <div class="main-heading">
                            MPT (Myanmar Moving Forward)
                        </div>
                    </div></br></br>
                    <div class="description">

                        <p class="big">
                            MPT has gained insightful knowledge through our plotting services withfiber cable lines,
                            location of MPT’s network towers and telephone cable networks on our GIS plotting maps.
                        </p>
                        </br></br>
                        <div>
                            <img src="/valuedclients/images/mpt-2.jpg" alt="mpt" class="responsives" />
                        </div>
