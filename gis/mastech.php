...
<html lang="en">
    ...
    <head>
        ...
        <title> MASTECH COMPANY LIMITED and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            Our transaction is- giving services to all towers in the whole country. Our cars are using
                            all day long (day and night). So we want to know about the real situation in real time.
                            After installing ‘GIS’ from DPS, we have known about the speed and arrival time of our
                            company vehicles. We can also guide our staffs about how to continue going from one place to
                            another because of knowing location in real time. Moreover, as GPS gives us printing
                            services, we give them the folder to insert the profile picture of our Co.ltd.
                        <div>
                            <img src="/valuedclients/images/mastech.jpg" alt="mastech" class="responsives" />
                        </div>
