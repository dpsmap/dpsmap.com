...
<html lang="en">
    ...
    <head>
        ...
        <title> Internet Wallet Myanmar and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
                ...
                <div class="map-description">
                    <div class="custom-heading">
                        <div class="main-heading">
                            Internet Wallet Myanmar Co .,Ltd.
                        </div>
                    </div></br></br>
                    <div class="description">

                        <p class="big">
                            Internet Wallet Myanmar Ltd. is servicing to be convenient such as fast and safe money
                            transferring in domestic, purchasing the ticket to travel , paying the meter bill , paying
                            the cash for online shopping, toping up the bill for all the domestic telephone operator by
                            using OK$. Mobile Application including the Point of the Node of Yangon GIS Map Road which
                            composed of Excel Data including the Latitude and Longitude values and Object ID Code which
                            are put in the Excel Title is intended to use for the Mobile Application users. DPS has
                            solved the requirements of the customers in short period.
                        </p>
                        </br></br>
                        <div>
                            <img src="/valuedclients/images/ewallet.jpg" alt="ewallet" class="responsives" />
                        </div>
