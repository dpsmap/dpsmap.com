...
<html lang="en">
    ...
    <head>
        ...
        <title> MYANMAR PADAUK and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            We provide Telecom Services. Every time we were assigned, Chin State Sagaing No, not at all.
                            Shan State Mandalay When the Kachin were assigned, we needed maps. You also need GPS Map to
                            submit Myanmar Telecommunication. So easy-to-use, DPS-enabled maps can be prepared before
                            going to the village level with our maps.
                        </p>
                        </br></br>
                        <div>
