...
<html lang="en">
    ...
    <head>
        ...
        <title> Hiang Kie Coffee and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            My Company is mainly distributes coffee machines in Yangon / Mandalay. Where we used to buy
                            machines, we want to put the business on a map Record sell his spread information, so it
                            wants a DPS-GIS map data purchased Yangon and Mandalay, we loaded distribution sectors
                            continue to expand more into the stores sold drinks Spread half of the filling Retail Outlet
                            DPS to-use GPS with offline machines show the DPS side Accessibility received in
                            satisfaction.
                        <div>
