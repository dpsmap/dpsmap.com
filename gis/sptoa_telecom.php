...
<html lang="en">
    ...
    <head>
        ...
        <title> SPT TELECOM and DPS Map </title>
        <style>
        .responsives {
            width: 300px;
            height: auto;
            ...
            <div class="main-content">
                <div class="map-description">
                    ...
                    <div class="description">
                        ...
                        <p class="big">
                            As a state GIS map for telecoms, they support the Yangon Region Map, where they can build
                            towers for their telecoms. The map was provided to help plan how the houses would be
                            covered.
                        </p>
                        </br></br>
                        <div>
                            <img src="/valuedclients/images/sptoa_telecom.jpg" alt="SPT TELECOM" class="responsives" />
                        </div>
