$(function() {
  ...
  $(document).mouseup(function (t) {
   ...
   $('#contact9').click(function() {
    $('#contactForm9').fadeToggle();
  })
  $(document).mouseup(function (q) {
    var container = $("#contactForm9");

    if (!container.is(q.target) 
        && container.has(q.target).length === 0) 
    {
        container.fadeOut();
    }
  });
    $('#contact10').click(function() {
    $('#contactForm10').fadeToggle();
  })
  $(document).mouseup(function (u) {
    var container = $("#contactForm10");

    if (!container.is(u.target) 
        && container.has(u.target).length === 0) 
    {
        container.fadeOut();
    }
  });
