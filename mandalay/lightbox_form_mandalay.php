...
/* Send the message using mail() function */
   if (count($errors) == 0) {		
			...
			$mailSub = 'Mandalay Map Download (http://dpsmap.com/mandalay/index.shtml)'; // the subject of the email which you can change
...
http://dpsmap.com/mandalay/images/mandalay.zip 
