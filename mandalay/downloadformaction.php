...
include("../db.php");
	...
	if(isset($_POST['btnMandalay']))//Start btnYangon
	{
	...
	/*************Send email to Owner Start***************************/
		...
		$mailSub = 'Mandalay Map Download (http://dpsmap.com/download/Mandalay Map.html)'; // the subject of the email which you can change
		...
		$message.="http://www.dpsmap.com/mandalay/confirmationmandalay.php?passkey=$confirm_code \r \n";
