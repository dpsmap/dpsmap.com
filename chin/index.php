...
<html lang="en">
  <head>
    ...
    <META NAME="keywords"
        ...
        <META NAME="description" content="Design Printing Services,Chin Map, Chin Map Free Download">
    <meta
    ...
    <div class="main-content">
                <div class="mission" style="padding-top: 30px;padding-bottom: 0px;">
                    <div class="description-container">
                            <div class="heading">
                                <div class="main-heading">The Map Of Chin</div>
                            </div>
                        <p class="description">
                            The Chin people were an independent nation until the British invaded their land in the late 19th century. 
                            The British annexed the Chins' territory into the British Empire in the early 20th century. 
                            The Chin people signed the Panglong Agreement in 1947. 
                            This agreement gave the Chin people their own state as part of the new government, the Union of Burma. 
                            The Chin people have a history of tribal wars and feuds from the 17th to the late 19th century. 
                            The British administration ended raids by the Chin on the plains of Myanmar.
                        </p>
                    </div>
                </div>
        </div>
      ...
      <div class="map-overview">
        <div class="map-overview-left">
          ...
          <div class="map-overview-image-container">
            <img src="../downloadmap/images/ChinMap.jpg" alt="Chin Map" />
          ...
          <div class="custom-row">
            <div class="heading">
              ...
              <div class="sub-heading">
                To download full and complete Chin Map
              </div>
            </div>

            <ol>
              <li>Press <a href="../pages/map-download/?value=Chin">Download</a></li>
