...
include("../db.php");
	...
	if(isset($_POST['btnInlay']))//Start btnInlay
	{
	...
	/*************Send email to Owner Start***************************/
		...
		$mailSub = 'Inlay Map Download (http://dpsmap.com/download/Inlay Map.html)'; // the subject of the email which you can change
		...
		$message.="http://www.dpsmap.com/inlay/confirmationinlay.php?passkey=$confirm_code \r \n";
