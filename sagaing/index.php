...
<html lang="en">
  <head>
    ...
    <META NAME="keywords"
        ...
        <META NAME="description" content="Design Printing Services,Sagaing Map, Sagaing, Sagaing Map Free Download">
    <meta
        ...
        <div class="main-content">
                <div class="mission" style="padding-top: 30px;padding-bottom: 0px;">
                    <div class="description-container">
                            <div class="heading">
                                <div class="main-heading">The Map Of Sagaing Region</div>
                    </div>
                        <p class="description">
                            Sagaing was the capital of Sagaing Kingdom (1315–1364), one of the minor kingdoms that rose up after the fall of Pagan dynasty, 
                            where one of Thihathu's sons, Athinkhaya, established himself. 
                            During the Ava period (1364–1555), the city was the common fief of the crown prince or senior princes.
                        </p>
                </div>
            </div>
        </div>
      ...
      <div class="map-overview">
        <div class="map-overview-left">
          ...
          <div class="map-overview-image-container">
            <img src="../downloadmap/images/SagaingM.jpg" alt="Sagaing Map" />
          ...
          <div class="custom-row">
            <div class="heading">
              ...
              <div class="sub-heading">
                To download full and complete Sagaing Map
              </div>
            </div>
