...
/* Send the message using mail() function */
   if (count($errors) == 0) {		
			...
			$mailSub = 'Mandalay Map Download (http://dpsmap.com/download/mandalay.html)'; // the subject of the email which you can change
			...
			foreach ($_POST as $field => $input) { 
				...
				$header2 .= "bcc: $BCCMail \r\n";				
				$mailsub2="Thank You for inquiring about downloading free mandalay map";
...
http://www.dpsmap.com/downloadmap/images/Mandalay.zip (2.79 MB)
