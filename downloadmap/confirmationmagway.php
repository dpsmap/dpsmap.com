...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8">
	<title>Design Printing Services, Magway Map</title>
					...
					<div class="row">
						<div class="wrap-col">
								<div class="header">
									<div class="row">
										<div class="col-4-5">
											<h1 style="font-size:20px;line-height:20px;letter-spacing:0px;">Magway Map Download</h1>
										</div>
										<div class="col-1-5">
									...
									if($result1)//if successfully queried
{
	...
	if($result2)
	{
       ...
       <p style="text-align:center;"> <button  onclick="window.location.href='images/Magway.zip';this.disabled=true; this.value='Please Wait...';" name="btndownload">Download Here</button></p>
<?php
...
?>
									...
									<div class="row">
										<div class="col-lg-12">
											<p style="padding:10px;">DPS၏ေျမပံုမ်ားသည္ ၀န္ထမ္းအင္အား၊အခ်ိန္အားအဘက္ဘက္တို႕မွ အကုန္အက်ခံေရးဆြဲထားေသာ DPS၏မူပိုင္ေျမပံုမ်ားျဖစ္ပါသည္။ ယခုDownloadလုပ္ရန္ေပးထားေသာေျမပံုသည္တစ္ဦးတစ္ေယာက္အတြက္အသံုးျပဳရန္သာျဖစ္ျပီးကိုယ္က်ိဳးစီးပြားအလို႕ငွာပံုႏိွပ္ျဖန္႕ျဖဴးေရာင္းခ်ျခင္းႏွင့္မည္သည့္စီးပြားေရးလုပ္ငန္းမ်ိဳးတြင္မဆိုအသံုးျပဳျခင္းအားတားျမစ္ထားပါသည္။သို႕ျဖစ္ပါေသာေၾကာင့္မည္သည့္ေျမပံုမ်ားကိုမဆိုအသံုးျပဳလိုပါကခြင့္ျပဳခ်က္ေတာင္းခံရမည္ျဖစ္ျပီး DPS ဘက္မွလည္းမွန္ကန္တိက်ျပီးအရည္အေသြးေကာင္းမြန္စြာႏွင့္အခ်ိန္တိုအတြင္းလူၾကီးမင္းတို႕လုိအပ္ခ်က္ကိုကူညီေဆာင္ရြက္ေပးသြားမည္ျဖစ္ေၾကာင္းေလးစားစြာ အသိေပးအပ္ပါသည္။</p>
										</div>
									</div>
									--->
