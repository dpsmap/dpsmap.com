...
/* Send the message using mail() function */
   if (count($errors) == 0) {		
			...
			$mailSub = 'Mon Map Download (http://dpsmap.com/download/mon.html)'; // the subject of the email which you can change
			...
			foreach ($_POST as $field => $input) { 
				...
				$header2 .= "bcc: $BCCMail \r\n";				
				$mailsub2="Thank You for inquiring about downloading free mon map";
...
http://www.dpsmap.com/downloadmap/images/Mon.zip (1.65 MB)
