...
/* Send the message using mail() function */
   if (count($errors) == 0) {		
			...
			$mailSub = 'Yangon Map Download (http://dpsmap.com/download/yangon.html)'; // the subject of the email which you can change
			...
			foreach ($_POST as $field => $input) { 
				...
				$header2 .= "bcc: $BCCMail \r\n";				
				$mailsub2="Thank You for inquiring about downloading free yangon map";
...
http://www.dpsmap.com/downloadmap/images/Yangon.zip (2.76 MB)
