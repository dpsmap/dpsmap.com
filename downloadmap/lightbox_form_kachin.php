...
/* Send the message using mail() function */
   if (count($errors) == 0) {		
			...
			$mailSub = 'Kachin Map Download (http://dpsmap.com/downloadmap/kachin.html)'; // the subject of the email which you can change
			...
			foreach ($_POST as $field => $input) { 
				...
				$header2 .= "bcc: $BCCMail \r\n";				
				$mailsub2="Thank You for inquiring about downloading free kachin map";
...
http://www.dpsmap.com/downloadmap/images/Kachin.zip (2.39 MB)
