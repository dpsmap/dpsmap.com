...
/* Send the message using mail() function */
   if (count($errors) == 0) {		
			...
			$mailSub = 'Kayah Map Download (http://dpsmap.com/download/kayah.html)'; // the subject of the email which you can change
			...
			foreach ($_POST as $field => $input) { 
				...
				$header2 .= "bcc: $BCCMail \r\n";				
				$mailsub2="Thank You for inquiring about downloading free kayah map";
...
http://www.dpsmap.com/downloadmap/images/Kayah.zip (1.61 MB)
