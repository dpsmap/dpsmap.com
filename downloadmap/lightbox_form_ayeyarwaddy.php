...
/* Send the message using mail() function */
   if (count($errors) == 0) {		
			...
			$mailSub = 'Ayeyarwaddy Map Download (http://dpsmap.com/downloadmap/ayeyarwaddy.html)'; // the subject of the email which you can change
			...
			foreach ($_POST as $field => $input) { 
				...
				$header2 .= "bcc: $BCCMail \r\n";				
				$mailsub2="Thank You for inquiring about downloading free ayeyarwaddy map";
$mailbody2="Thanks for your download.
We received your map download inquiry with many thanks. You click this link for download.

http://www.dpsmap.com/downloadmap/images/Ayeyarwaddy.zip (2.39 MB)
...
";
				...
				$sendRem2 = mail($email , $mailsub2 ,$mailbody2 , $header2);
