...
/* Send the message using mail() function */
   if (count($errors) == 0) {		
			...
			$mailSub = 'Chin Map Download (http://dpsmap.com/download/chin.html)'; // the subject of the email which you can change
			...
			foreach ($_POST as $field => $input) { 
				...
				$header2 .= "bcc: $BCCMail \r\n";				
				$mailsub2="Thank You for inquiring about downloading free chin map";
...
http://www.dpsmap.com/downloadmap/images/Chin.zip (2.32 MB)
