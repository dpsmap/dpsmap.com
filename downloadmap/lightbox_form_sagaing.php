...
/* Send the message using mail() function */
   if (count($errors) == 0) {		
			...
			$mailSub = 'Sagaing Map Download (http://dpsmap.com/download/sagaing.html)'; // the subject of the email which you can change
			...
			foreach ($_POST as $field => $input) { 
				...
				$header2 .= "bcc: $BCCMail \r\n";				
				$mailsub2="Thank You for inquiring about downloading free sagaing map";
...
http://www.dpsmap.com/downloadmap/images/Sagaing.zip (2.17 MB)
