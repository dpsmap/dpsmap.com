...
<html lang="en">
  <head>
    ...
    <META NAME="keywords"
        ...
        <META NAME="description" content="Design Printing Services,Kachin Map, Kachin Map Free Download">
    <meta
        ...
        <div class="main-content">
                <div class="mission" style="padding-top: 30px;padding-bottom: 0px;">
                    <div class="description-container">
                            <div class="heading">
                                <div class="main-heading">The Map Of Kachin </div>
                            </div>
                        <p class="description">
                            Smallest of the Major National Ethnic Races in Myanmar are the Kachin people, also known as (Singhpo). 
                            They are mainly living in North-Eastern Myanmar in Kachin Hills and neighbouring Yunnan Province, China and Arunachal Pradesh, India. 
                            The name of ‘Singhpo’ is a variation of ‘Jingpo’. About one million Kachin peoples live in the region.
                        </p>
                    </div>
                </div>
        </div>
      ...
      <div class="map-overview">
        <div class="map-overview-left">
          ...
          <div class="map-overview-image-container">
            <img src="../downloadmap/images/KachinM.jpg" alt="Kachin Map" />
          ...
          <div class="custom-row">
            <div class="heading">
              ...
              <div class="sub-heading">
                To download full and complete Kachin Map
              </div>
            </div>
