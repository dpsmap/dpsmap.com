...
/* Send the message using mail() function */
   if (count($errors) == 0) {		
			...
			$mailSub = 'Mrauk U Map Download (http://dpsmap.com/mrauku/index.shtml)'; // the subject of the email which you can change
			...
			foreach ($_POST as $field => $input) { 
				...
				$header2 .= "bcc: $BCCMail \r\n";				
				$mailsub2="Thank You for inquiring about downloading free mrauku map";
...
http://bit.ly/muaukuly (410.46 KB)
