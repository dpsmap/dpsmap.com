...
/* Send the message using mail() function */
   if (count($errors) == 0) {		
			...
			$mailSub = 'Asean Map Download (dpsmap.com/myanmar/asean_map.html)'; // the subject of the email which you can change
			...
			foreach ($_POST as $field => $input) { 
				...
				$header2 .= "bcc: $BCCMail \r\n";				
				$mailsub2="Thank You for inquiring about downloading free asean map";
