...
/* Send the message using mail() function */
   if (count($errors) == 0) {		
			...
			$mailSub = 'Myanmar Map English Version Download (http://dpsmap.com/myanmar/index.shtml)'; // the subject of the email which you can change
			...
			foreach ($_POST as $field => $input) { 
				...
				$header2 .= "bcc: $BCCMail \r\n";				
				$mailsub2="Thank You for inquiring about downloading free myanmar map (english version)";
...
http://bit.ly/myanmarely (9.03 MB)
