...
/* Send the message using mail() function */
   if (count($errors) == 0) {		
			...
			$mailSub = 'Mawlamying Map Download (http://dpsmap.com/Mawlamying/index.shtml)'; // the subject of the email which you can change
			...
			foreach ($_POST as $field => $input) { 
				...
				$header2 .= "bcc: $BCCMail \r\n";				
				$mailsub2="Thank You for inquiring about downloading free Mawlamying map";
...
https://dpsmap.com/mawlamying/images/mawlamying_map_big.zip
