...
/* Send the message using mail() function */
   if (count($errors) == 0) {		
			...
			$mailSub = 'Amarapura Map Download (http://dpsmap.com/amarapura/index.shtml'; // the subject of the email which you can change
			...
			foreach ($_POST as $field => $input) { 
				...
				$header2 .= "bcc: $BCCMail \r\n";				
				$mailsub2="Thank You for inquiring about downloading free amarapura map";
...
http://bit.ly/amarapuraly (2.06 MB)
